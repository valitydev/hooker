...
public class InvoicePaymentCashFlowChangedHandler extends NeedReadInvoiceEventHandler {
    ...
    public InvoicePaymentCashFlowChangedHandler() {
        this.filter = new PathConditionFilter(new PathConditionRule(eventType.getThriftFilterPathCoditionRule(), new IsNullCondition().not()));
    }
